...
> [!WARNING]
> Qlib 在 Windows 或某些 Python 版本下可能因 C++ 编译或 NumPy 版本冲突而安装失败。**强烈推荐使用 Python 3.12 (或 Linux/WSL 环境)** 以获得最佳兼容性。
...
3. 无交易日使用空模板 `emp-table.xlsx` (可以从 `data/templates/emp-table.xlsx` 复制)
